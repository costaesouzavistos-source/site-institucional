...
export const Route = createLPRoute({
  ...
  title: "Visto Americano em Goiânia | Costa & Souza",
  description:
    "Visto americano em Goiânia e região. Atendimento online para quem mora em Goiás, com assessoria especializada e acompanhamento até a aprovação.",
  keywords:
