...
export const Route = createLPRoute({
  ...
  title: "Como Tirar Visto Americano | Guia 2026 | Costa & Souza",
  description:
    "Passo a passo completo para tirar o visto americano. Entenda documentos, DS-160, entrevista e aprovação. Atendimento em todo o Brasil.",
  keywords:
    "como tirar visto americano, passo a passo visto americano, documentos visto americano, entrevista visto americano, DS-160",
  ...
  heroTitle: "Como tirar visto americano",
  ...
  solutionTitle: "Os 5 passos para tirar o visto americano com segurança",
  solutionPoints: [
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "De 30 a 90 dias em média, dependendo da disponibilidade de entrevista no consulado.",
    },
    {
